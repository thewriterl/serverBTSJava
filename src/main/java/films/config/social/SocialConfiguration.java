package films.config.social;

import films.repository.SocialUserConnectionRepository;
import films.repository.CustomSocialUsersConnectionRepository;
import films.security.social.CustomSignInAdapter;
