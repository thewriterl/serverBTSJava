...
describe('Service Tests', () => {
    ...
    describe('ProductionCountries Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProductionCountriesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/production-countries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProductionCountries', () => {
